            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              VisoraCard(padding: const EdgeInsets.all(20), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text('Age', style: GoogleFonts.inter(fontSize: 14, color: VisoraColors.onSurface)),
                  Text('${_age.round()}', style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w700, color: VisoraColors.onSurface)),
                ]),
                Slider(value: _age, min: 18, max: 80,
                  onChanged: (v) => setState(() => _age = v)),
                Padding(padding: const EdgeInsets.symmetric(horizontal: 4),
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text('18', style: GoogleFonts.inter(fontSize: 12, color: VisoraColors.onSurfaceVariant)),
                    Text('80', style: GoogleFonts.inter(fontSize: 12, color: VisoraColors.onSurfaceVariant)),
                  ])),
                ...
                // Hours/Week slider
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text('Hours/Week', style: GoogleFonts.inter(fontSize: 14, color: VisoraColors.onSurface)),
                  Text('${_hours.round()} hrs', style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w700, color: VisoraColors.onSurface)),
                ]),
                Slider(value: _hours, min: 0, max: 80,
                  onChanged: (v) => setState(() => _hours = v)),
                Padding(padding: const EdgeInsets.symmetric(horizontal: 4),
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text('0', style: GoogleFonts.inter(fontSize: 12, color: VisoraColors.onSurfaceVariant)),
                    Text('80', style: GoogleFonts.inter(fontSize: 12, color: VisoraColors.onSurfaceVariant)),
                  ])),
                ...
                // Education dropdown
                Text('Education Level', style: GoogleFonts.inter(fontSize: 14, color: VisoraColors.onSurface)),
                const SizedBox(height: 8),
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      icon: Icon(Icons.expand_more_rounded, color: VisoraColors.onSurfaceVariant),
                ...
                // Race dropdown
                Text('Race / Ethnicity', style: GoogleFonts.inter(fontSize: 14, color: VisoraColors.onSurface)),
                const SizedBox(height: 8),
                Container(
                  padding: const EdgeInsets.symmetric(horizontal: 16),
                  decoration: BoxDecoration(
                ...
                // Gender toggle
                Text('Gender', style: GoogleFonts.inter(fontSize: 14, color: VisoraColors.onSurface)),
                const SizedBox(height: 8),
                Container(
                  decoration: BoxDecoration(
                    border: Border.all(color: VisoraColors.outline),
